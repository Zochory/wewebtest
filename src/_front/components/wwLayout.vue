...
import { getDisplayValue, inheritFrom } from '@/_common/helpers/component/component';
    ...
    watch: {
     ...
     methods: {
        getItemStyle(index) {
            ...
            //Reverse
            if (this.componentContent['_ww-layout_reverse']) {
                style.order = this.restrictedLength - 1 - index;
            } else {
                style.order = index;
            }
            ...
            if (this.componentContent['_ww-layout_pushLast']) {
                const push = !this.componentContent['_ww-layout_reverse']
                    ...
                    : index === 0;
                if (push) {
                    if (this.componentContent['_ww-layout_flexDirection'] === 'column') {
