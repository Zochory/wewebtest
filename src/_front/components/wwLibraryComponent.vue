<template>
    ...
    <wwElementComponent
        ...
        :is-library-component-conditional-rendering-responsive="isConditionalRenderingResponsive"
        v-bind="$attrs"
...
<script>
import { ref, inject, provide, computed, reactive, onBeforeUnmount, shallowRef } from 'vue';
...
import { useComponentData, useComponentTriggerEvent, useLibraryComponentWorkflow } from '@/_common/use/useComponent';
import { useInner } from '@/_front/use/useInner';
import { useComponentStates } from '@/_front/use/useComponentStates';
import { useLibraryComponentActions } from '@/_common/use/useActions';
...
export default {
    ...
    setup(props) {
        ...
        provide('_wwLibraryComponentUid', props.uid);
        ...
        return {
            ...
            elementComponent,
             /* wwFront:start */
            isConditionalRenderingResponsive,
            /* wwFront:end */
        };
    },
    computed: {
