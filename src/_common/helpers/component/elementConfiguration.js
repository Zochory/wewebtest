        ...
        '_ww-text_fontSize': {
            ...
            options: {
                unitChoices: [
                    ...
                    { value: 'em', label: 'em', min: 0, max: 10, digits: 2, step: 0.1 },
                    { value: 'rem', label: 'rem', min: 0, max: 10, digits: 2, step: 0.1 },
                ],
                noRange: true,
            },
            responsive: true,
        ...
        '_ww-text_letterSpacing': {
            ...
            options: {
                unitChoices: [
                    ...
                    { value: 'em', label: 'em', min: -10, max: 10, digits: 2, step: 0.1 },
                    { value: 'rem', label: 'rem', min: -10, max: 10, digits: 2, step: 0.1 },
                ],
                noRange: true,
            },
            responsive: true,
