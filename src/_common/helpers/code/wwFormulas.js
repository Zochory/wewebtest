...
export const _wwFormulas = {
    ...
    length(arr) {
        arr = wwLib.wwCollection.getCollectionData(arr);
    ...
    merge(...args) {
        const _args = args.map(arg => {
            const _arg = wwLib.wwCollection.getCollectionData(arg);
    ...
    lookupArray(arrValues, arr, key = 'id') {
        arr = wwLib.wwCollection.getCollectionData(arr);
        arrValues = wwLib.wwCollection.getCollectionData(arrValues);
