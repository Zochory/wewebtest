export default {
    ...
    getVariable: state => uid => {
        return (
            state.variables[uid] ||
            state.componentVariables[uid] ||
            state.pluginVariables[uid] ||
            state.pageParameterVariables[uid]
        );
    },
    getFormulas(state) {
    ...
    getPluginTriggers(state) {
        return state.pluginTriggers;
    },
};
